...
public class Stats extends Sprite {
	...
	private const hurt_CAPTION:String = " !!! hurt Stats object. ಠ_ಠ";
	...
	private function initContextMenu():void {
		...
		var hurtMenuItem:ContextMenuItem = new ContextMenuItem(hurt_CAPTION, true);
		hurtMenuItem.addEventListener(ContextMenuEvent.MENU_ITEM_SELECT, destroy, false, 0, true);
